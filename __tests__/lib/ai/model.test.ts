...
describe("ModelManager", () => {
  ...
  test("loadModel respects quantization configuration", async () => {
    ...
    const loadPromiseWithQuant = modelManager.loadModel("model-with-quant", {
    ...
    const loadPromiseWithoutQuant = modelManager.loadModel("model-without-quant", {
  ...
  test("loadModel handles errors properly", async () => {
    ...
    await expect(modelManager.loadModel("error-model")).rejects.toThrow("Mock loading error");
